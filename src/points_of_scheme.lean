...
{ to_fun := λ P, 
  ...
  begin
    ...
    resetI,
    ext : 1, swap,
    { dsimp only, rw [←Scheme.comp_val_base_apply, iso.hom_inv_id, Scheme.id_val_base, id_apply] },
    { sorry }
  end,
  right_inv := λ P,
  begin 
    ...
    resetI,
    ext : 1, swap,
    { dsimp only, rw [←Scheme.comp_val_base_apply, iso.inv_hom_id, Scheme.id_val_base, id_apply] },
    { sorry }, 
  end }
